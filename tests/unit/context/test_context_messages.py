...
def test_tool_result_message_keeps_large_artifact_output_out_of_model_content() -> None:
    result = {
        ...
        "model_visible": {
            ...
            "status": "success",
            "content": "x" * 200 + "\n...[12600 characters omitted]...\n" + "x" * 200,
            "content_format": "text",
            "artifact": {
                "path": ".runs/episode/artifacts/tool-results/mcp_fixture.txt",
    ...
    assert payload["artifact"]["path"] == ".runs/episode/artifacts/tool-results/mcp_fixture.txt"
    assert payload["truncation"]["occurred"] is True
